...
**Can be used as a URL Encoder. NB: CyberChef uses strict encoding, e.g. it will URL encode chars such as `-`. If you are having issues, try `URL Encoder`, above, which has less strict encoding.**
